...
declare module '$env/static/private' {
	...
	export const npm_package_dependencies_feather_icons: string;
	export const npm_package_dependencies_read_excel_file: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		npm_package_dependencies_feather_icons: string;
		npm_package_dependencies_read_excel_file: string;
